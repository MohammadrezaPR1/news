...
export default function TopBar({ toggleSidebar, isMobile, sidebarWidth }) {
    ...
    return (
        <header
            className="fixed top-0 left-0 right-0 h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 z-40 flex items-center justify-between px-6 transition-all duration-300"
            dir="rtl"
        ...
        >
            ...
            <div className="flex items-center gap-2 sm:gap-6" dir="ltr">
                <Link to={`/admin-update-profile/${userId}`} className="flex items-center gap-3 pr-4 border-r border-slate-200 group hover:opacity-80 transition-opacity">
                    ...
                    <div className="w-10 h-10 rounded-full border-2 border-white shadow-sm overflow-hidden bg-slate-100 group-hover:border-indigo-100 transition-all">
