...
import { FiEdit3, FiSave, FiX, FiTag } from "react-icons/fi";
...
const EditCategory = () => {
    const { editCategory } = useContext(AdminContext);
    const { id } = useParams();
        ...
        <Dashboard>
            <div dir="rtl" className="max-w-2xl mx-auto py-12 px-4">
                <div className="mb-10 text-center">
                    ...
                    <p className="text-slate-500 font-bold text-sm">عنوان دسته‌بندی یا تنظیمات مرتبط را اصلاح کنید</p>
                </div>
