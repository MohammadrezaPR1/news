                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 rounded-2xl font-black text-sm text-slate-500 bg-slate-100 hover:bg-slate-200 transition-all"
                        >
                            <FiX />
                            انصراف
                        </button>
                        <button
                            ...
                            className="flex items-center gap-2 px-8 py-3 rounded-2xl font-black text-sm text-white bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-100 transition-all"
                        >
                            <FiSave />
                            آماده انتشار
                        </button>
