                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-8 py-3 rounded-2xl font-black text-sm text-white bg-amber-500 hover:bg-amber-600 shadow-xl shadow-amber-100 transition-all"
                        >
                            <FiSave />
                            بروزرسانی نهایی
                        </button>
