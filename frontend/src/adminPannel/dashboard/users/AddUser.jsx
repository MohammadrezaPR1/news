...
import { FiUserPlus, FiUser, FiMail, FiLock, FiShield, FiSave, FiX } from "react-icons/fi";
...
const formSchema = yup.object({
  ...
  password: yup.string().min(6, "پسورد باید حداقل ۶ کاراکتر باشد").required("انتخاب پسورد برای کاربر الزامی است"),
  confPassword: yup.string().oneOf([yup.ref('password'), null], 'تکرار پسورد با پسورد اصلی مطابقت ندارد').required("تکرار پسورد الزامی است"),
      ...
      <div dir="rtl" className="max-w-3xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 font-bold text-sm">دسترسی‌های جدید برای تیم تحریریه ایجاد کنید</p>
          </div>
        </div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-slate-400 tracking-tight">دسترسی محدود به محتوا</div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-[10px] font-bold text-slate-400 tracking-tight">دسترسی کامل مدیریتی</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex gap-4 pt-4 border-t border-slate-50">
              ...
              <button
                ...
                className="px-8 bg-slate-100 hover:bg-slate-200 text-slate-500 h-14 rounded-2xl font-black text-sm transition-all"
              >
                انصراف
              </button>
            </div>
