    ...
    <Dashboard>
      <div dir="rtl" className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          <div>
            <h2 className="text-3xl font-black text-slate-900 mb-2">مدیریت کاربران</h2>
            <p className="text-slate-500 font-bold text-sm">لیست تمامی کاربران، خبرنگاران و مدیران سیستم</p>
          </div>

          <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-2xl shadow-sm border border-slate-100 flex-1 max-w-md">
