    ...
    <Dashboard>
      <div dir="rtl" className="max-w-4xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-10">
          <div>
            <h2 className="text-3xl font-black text-slate-900 mb-2">افزودن ویدیو</h2>
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-8">
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <button
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-12 py-4 rounded-[20px] font-black text-sm shadow-xl shadow-indigo-100 transition-all hover:-translate-y-1 flex items-center gap-2"
            >
              <FiSave size={20} />
