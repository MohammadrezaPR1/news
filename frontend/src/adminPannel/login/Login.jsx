  ...
  return (
    <div className="min-h-screen flex w-full bg-[#f8fafc] overflow-hidden font-['vazir']" dir="rtl">
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-6 bg-white lg:bg-slate-50 shadow-2xl z-20">
        ...
        {/* باکس اصلی فرم */}
        <div className="w-full max-w-[420px] bg-white rounded-[40px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-slate-100">
          
          <div className="text-center mb-10">
            <div className="inline-block relative">
              <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-400 p-1 shadow-md">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pr-12 pl-4 outline-none transition-all focus:border-blue-600 focus:bg-white font-bold text-slate-800"
                />
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pr-12 pl-4 outline-none transition-all focus:border-blue-600 focus:bg-white font-bold text-slate-800"
                />
                <FaLock className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-blue-600 transition-colors" />
              </div>
